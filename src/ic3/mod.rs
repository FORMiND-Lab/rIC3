...
pub struct IC3 {
    ...
    block_async_batches_launched: usize,
    block_full_root_admission: block::BlockFullRootAdmission,
    mic_batch_policy: mic::MicBatchPolicy,
    mic_chain_policy: mic::MicChainPolicy,
...
impl IC3 {
    pub fn new(cfg: IC3Config, mut ts: Transys, symbols: VarSymbols) -> Self {
        ...
        Self {
            ...
            block_async_batches_launched: 0,
            block_full_root_admission: Default::default(),
            mic_batch_policy: Default::default(),
            mic_chain_policy: Default::default(),
